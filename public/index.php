...
$router->get('seguimiento', 'App\Controllers\TrackingController@showForm');
$router->post('seguimiento', 'App\Controllers\TrackingController@track');
$router->get('cuenta', 'App\Controllers\AccountController@index');
$router->get('cuenta/pedidos', 'App\Controllers\AccountController@orders');
$router->get('cuenta/pedidos/{id}', 'App\Controllers\AccountController@orderShow');
...
$router->post('admin/productos/producto-mes/{id}', 'App\Controllers\Admin\ProductController@toggleProductOfMonth');
...
$router->get('admin/promociones', 'App\Controllers\Admin\PromotionController@edit');
$router->post('admin/promociones/guardar', 'App\Controllers\Admin\PromotionController@save');
